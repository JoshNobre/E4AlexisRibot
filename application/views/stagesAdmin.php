...
<html>
	<head>
		...
		<title>Administration des stages</title>
    ...
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown active">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="<?php echo site_url('stagesAdmin/stages') ?>">Ajout d'un stage</a></li>
            <li><a href="<?php echo site_url('stagesAdminList/stagesList') ?>">Liste des participants</a></li>
          </ul>
        </li>
...
<?php 
    ...
    $nomStage = array(
        ...
        echo '<label class="control-label col-lg-8"> Nom du stage </label>';
        echo form_input($nomStage);
        echo '<br/>';
    ...
    $dateStage = array(
        ...
        echo '<label class="control-label col-lg-8"> Date du stage </label>';
        echo form_input($dateStage);
        echo '<br/>';
